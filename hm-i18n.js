...
en:{
  ...
  "info.photo.l":"<li><b>🎯 Live lane</b> aim the camera at the finish line and start a heat.</li><li><b>🎞 Finish image · 🏁 Results</b> the moment of crossing and the precise time for each lane.</li><li><b>🔄 Laps · 🗄 Archive</b> longer races, and earlier heats to go back to.</li>",
...
ar:{
  ...
  "info.photo.l":"<li><b>🎯 المسار المباشر</b> وجّه الكاميرا إلى خط النهاية وابدأ سباقًا.</li><li><b>🎞 صورة النهاية · 🏁 النتائج</b> لحظة العبور والزمن الدقيق لكل مسار.</li><li><b>🔄 اللفّات · 🗄 الأرشيف</b> سباقات طويلة، وسباقات سابقة للعودة إليها.</li>",
...
ru:{
  ...
  "info.photo.l":"<li><b>🎯 Живая дорожка</b> наведите камеру на линию финиша и начните забег.</li><li><b>🎞 Снимок финиша · 🏁 Результаты</b> момент пересечения и точное время по каждой дорожке.</li><li><b>🔄 Круги · 🗄 Архив</b> длинные забеги и прошлые забеги, к которым можно вернуться.</li>",
...
es:{
  ...
  "info.photo.l":"<li><b>🎯 Calle en directo</b> apunta la cámara a la línea de meta y empieza una serie.</li><li><b>🎞 Imagen de llegada · 🏁 Resultados</b> el momento del cruce y el tiempo exacto de cada calle.</li><li><b>🔄 Vueltas · 🗄 Archivo</b> carreras largas, y series anteriores a las que volver.</li>",
